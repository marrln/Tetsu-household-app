    ...
    val Factory = viewModelFactory {
        ...
        initializer {
            ItemEditViewModel(
                ...
                tetsuHouseholdApp().container.itemsRepository
            )
        }
        // Initializer for ItemEntryViewModel
        initializer {
            ItemEntryViewModel(tetsuHouseholdApp().container.itemsRepository)
        }
        ...
        initializer {
            HomeViewModel(tetsuHouseholdApp().container.itemsRepository)
        }
    }
}
 ...
 * [TetsuHouseholdApp].
 */
fun CreationExtras.tetsuHouseholdApp(): TetsuHouseholdApp =
    (this[AndroidViewModelFactory.APPLICATION_KEY] as TetsuHouseholdApp)
